...
// Active color variables - these are the ones referenced throughout the codebase.
// They default to Mocha and are updated by SetTheme().
var (
	...
	// CurrentTheme tracks which theme is active
	CurrentTheme ThemeName = ThemeMocha
)

// SetTheme switches to a different Catppuccin flavor.
// It updates all package-level color variables.
